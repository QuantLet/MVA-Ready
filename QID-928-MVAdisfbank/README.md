...
Description : 'Performs a Fisher discrimination analysis of the
Swiss bank notes, computes the misclassification
rates for the whole dataset and displays nonparametric density
...
Datafile : bank2.dat
Example : Densities of projections of genuine and counterfeit bank notes by Fisher's discrimination
rule.
```
...
# Fisher, density, projection, Fisher LDA projection, nonparametric,
